...
function logLoad(tab){
    ...
    currentTab.port.emit('highlightLinks', aActivity);
    print("page load detected"+ tab.url);
}
...
exports.main = function(){
    ...
    upload.port.on('fileUploaded', function(activity){
        ...
        activetab.port.emit('highlightLinks', activity);
        tabs.on('load', logLoad);
        //tabs.on('load', onTabOpen);

        //console.log("in file upload");
        //tabs.on('pageShow', logLoad);
